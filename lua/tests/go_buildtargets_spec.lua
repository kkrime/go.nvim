...
describe('Resolve Collisions:', function()
  ...
  it("test case 1 - 3 target name collisions", function()
    -- "/Users/kkrime/go/src/prj/internal/zerrors/generate/error_creator.go"
    -- "/Users/kkrime/go/src/prj/internal/error_creator.go"
  ...
  it("test case 2 - expanding target name all the way to the project root", function()
    ...
    -- "/Users/kkrime/go/src/prj/internal/error_creator.go"
    -- "/Users/kkrime/go/src/prj/prj/internal/error_creator.go"
    local targets_map = {}
  ...
  it("test case 7 - expand 4 colliding target name", function()
    ...
    -- /Users/kkrime/go/src/prj/external/api/assets/generator.go
    -- /Users/kkrime/go/src/prj/external/api/assets/generator/main.go
    local targets_map = {}
